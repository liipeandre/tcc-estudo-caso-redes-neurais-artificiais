...
def MainP1():
    ...
    lista_strings_entrada = ["-fa tanh logistic -m 0.0 -ta 0.1 -t [10] [50] [100] -bs 1 3 7 14 29 58 117 234 468 937 1875 3750 7500 -nc 1 -arq ResultadoTestesParte1.txt",
                             "-fa tanh logistic -m 0.0 -ta 0.1 -t [500] [1000] -bs 1 3 7 14 29 58 117 234 468 937 1875 3750 7500 -nc 1 -arq ResultadoTestesParte2.txt",
                             "-fa tanh logistic -m 0.0 -ta 0.1 -t [10] [50] [100] -bs 234 -nc 1 10 20 30 40 50 100 200 300 400 500 1000 -arq ResultadoTestesParte3.txt",
                             "-fa tanh logistic -m 0.0 -ta 0.1 -t [500] [1000] -bs 234 -nc 1 10 20 30 40 50 100 200 300 400 500 1000 -arq ResultadoTestesParte4.txt"]
