...
from Modulos.EntradaUsuario import Gerador
...
def MainP1():
    ...
    # declaro uma lista com os numero de neuronios utilizados.
    ...
    lista_strings_entrada = ["-fa tanh logistic -m 0.0 -ta 0.1 -t " + Gerador(2, lista, 0, 6) + Gerador(3, lista, 0, 31) + Gerador(4, lista, 0, 156) + "-bs 234 -nc 1 -arq ResultadoTestesParte1.txt",
                             "-fa tanh logistic -m 0.0 -ta 0.1 -t " + Gerador(2, lista, 6, 12) + Gerador(3, lista, 31, 62) + Gerador(4, lista, 156, 312) + "-bs 234 -nc 1 -arq ResultadoTestesParte2.txt",
                             "-fa tanh logistic -m 0.0 -ta 0.1 -t " + Gerador(2, lista, 12, 18) + Gerador(3, lista, 62, 93) + Gerador(4, lista, 312, 468) + "-bs 234 -nc 1 -arq ResultadoTestesParte3.txt",
                             "-fa tanh logistic -m 0.0 -ta 0.1 -t " + Gerador(2, lista, 18, 25) + Gerador(3, lista, 93, 125) + Gerador(4, lista, 468, 625) + "-bs 234 -nc 1 -arq ResultadoTestesParte4.txt"]
    ...
    for string_entrada in lista_strings_entrada:
        ...
        # inicio a úttima thread criada (-1 é o fim da lista, ou seja, o elemento recém inserido).
